 ...
 */
#ifndef LOCATION_SERVICE_DEFAULT_PERMISSION_MANAGER_H_
#define LOCATION_SERVICE_DEFAULT_PERMISSION_MANAGER_H_
...
#endif // LOCATION_SERVICE_DEFAULT_PERMISSION_MANAGER_H_
