 ...
 */
#ifndef LOCATION_SERVICE_SKELETON_H_
#define LOCATION_SERVICE_SKELETON_H_

#include <location/service/interface.h>
...
{
class Skeleton
        : public core::dbus::Skeleton<location::service::Interface>,
...
#endif // LOCATION_SERVICE_SKELETON_H_
