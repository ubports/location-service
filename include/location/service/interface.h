 ...
 */
#ifndef LOCATION_SERVICE_INTERFACE_H_
#define LOCATION_SERVICE_INTERFACE_H_
...
class Interface
{
  protected:
    ...
    {
        typedef location::service::Interface Interface;
    ...
    struct Properties
    {
        ...
        struct VisibleSpaceVehicles
        {
            ...
            typedef location::service::Interface Interface;
            typedef std::map<location::SpaceVehicle::Key, location::SpaceVehicle> ValueType;
...
{
template<>
struct Service<location::service::Interface>
{
