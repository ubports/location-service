 ...
 */
#ifndef LOCATION_CONNECTIVITY_WIRELESS_NETWORK_H_
#define LOCATION_CONNECTIVITY_WIRELESS_NETWORK_H_

#include <location/connectivity/bounded_integer.h>
...
#endif // LOCATION_CONNECTIVITY_WIRELESS_NETWORK_H_
