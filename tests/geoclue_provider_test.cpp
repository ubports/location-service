 ...
 */
#include <location/providers/geoclue_provider.h>
...
TEST(GeoclueProvider, accessing_ubuntu_geo_ip_works)
{
    ...
    location::geoclue::Provider::Configuration config
    {
        name,
        path,
        location::geoclue::Provider::default_feature_flags(),
        location::geoclue::Provider::default_requirement_flags(),
    };

    location::geoclue::Provider provider(config);
