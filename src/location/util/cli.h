 ...
 *
 */
#ifndef LOCATION_UTIL_CLI_H_
#define LOCATION_UTIL_CLI_H_
...
/// Prefix[===============----------] xxx.xx %
///         |--------------- width ------------|
class LOCATION_DLL_PUBLIC ProgressBar
{
public:
...
class LOCATION_DLL_PUBLIC SizeConstrainedString
{
public:
...
template<std::size_t max>
LOCATION_DLL_PUBLIC bool operator<(const SizeConstrainedString<max>& lhs, const SizeConstrainedString<max>& rhs)
{
...
template<std::size_t max>
LOCATION_DLL_PUBLIC std::ostream& operator<<(std::ostream& out, const SizeConstrainedString<max>& scs)
{
...
template<typename T>
class LOCATION_DLL_PUBLIC TypedFlag : public Flag
{
public:
...
template<typename T>
class LOCATION_DLL_PUBLIC TypedReferenceFlag : public Flag
{
public:
    // Safe us some typing.
...
template<typename T>
class LOCATION_DLL_PUBLIC OptionalTypedReferenceFlag : public Flag
{
public:
...
class LOCATION_DLL_PUBLIC Command : public DoNotCopyOrMove
{
public:
    // Safe us some typing
...
class LOCATION_DLL_PUBLIC CommandWithSubcommands : public Command
{
public:
...
class LOCATION_DLL_PUBLIC CommandWithFlagsAndAction : public Command
{
public:
...
LOCATION_DLL_PUBLIC std::vector<std::string> args(int argc, char** argv);

/// @brief make_flag returns a flag with the given name and description.
template<typename T>
LOCATION_DLL_PUBLIC typename TypedFlag<T>::Ptr make_flag(const Name& name, const Description& description)
{
...
template<typename T>
LOCATION_DLL_PUBLIC typename TypedReferenceFlag<T>::Ptr make_flag(const Name& name, const Description& desc, T& value)
{
...
template<typename T>
LOCATION_DLL_PUBLIC typename OptionalTypedReferenceFlag<T>::Ptr make_flag(const Name& name, const Description& desc, Optional<T>& value)
{
