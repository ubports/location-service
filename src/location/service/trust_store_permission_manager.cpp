...
#include <location/service/config.h>
...
location::service::TrustStorePermissionManager::AppArmorProfileResolver location::service::TrustStorePermissionManager::libapparmor_profile_resolver()
{
...
core::trust::Feature location::service::TrustStorePermissionManager::default_feature()
{
    return core::trust::Feature{0};
}

location::service::TrustStorePermissionManager::Ptr location::service::TrustStorePermissionManager::create_default_instance_with_bus(const std::shared_ptr<core::dbus::Bus>& bus)
{
    return Ptr
    {
        new TrustStorePermissionManager
        {
            core::trust::dbus::create_multi_user_agent_for_bus_connection(
                        bus,
                        location::service::trust_store_service_name),
            TrustStorePermissionManager::libapparmor_profile_resolver()
        }
    };
}

location::service::TrustStorePermissionManager::TrustStorePermissionManager(
        const std::shared_ptr<core::trust::Agent>& agent,
        location::service::TrustStorePermissionManager::AppArmorProfileResolver app_armor_profile_resolver)
    : agent{agent},
      app_armor_profile_resolver{app_armor_profile_resolver}
{
}

location::service::PermissionManager::Result location::service::TrustStorePermissionManager::check_permission_for_credentials(
        ...
        const location::service::Credentials& credentials)
{
    ...
    } catch(const std::exception& e)
    {
        ...
        return location::service::PermissionManager::Result::rejected;
    } catch(...)
    {
