 ...
 */
#ifndef LOCATION_SERVICE_PROVIDER_DAEMON_H_
#define LOCATION_SERVICE_PROVIDER_DAEMON_H_

#include <location/provider.h>

#include <location/service/dbus_connection_factory.h>
...
#endif // LOCATION_SERVICE_PROVIDER_DAEMON_H_
