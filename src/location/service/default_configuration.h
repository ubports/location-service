 ...
 */
#ifndef LOCATION_SERVICE_DEFAULT_CONFIGURATION_H_
#define LOCATION_SERVICE_DEFAULT_CONFIGURATION_H_

#include <location/service/configuration.h>
...
#endif // LOCATION_SERVICE_DEFAULT_CONFIGURATION_H_
