...
struct location::service::session::Stub::Private
{
    Private(Stub* parent,
...
location::service::session::Stub::Stub(const dbus::Bus::Ptr& bus,
                  const dbus::types::ObjectPath& session_path)
        : dbus::Stub<location::service::session::Interface>(bus),
        d(new Private(this,
                      session_path,
...
{
    d->object->install_method_handler<location::service::session::Interface::UpdatePosition>(
        std::bind(&Stub::Private::update_position,
                  std::ref(d),
                  std::placeholders::_1));
    d->object->install_method_handler<location::service::session::Interface::UpdateHeading>(
        std::bind(&Stub::Private::update_heading,
                  std::ref(d),
                  std::placeholders::_1));
    d->object->install_method_handler<location::service::session::Interface::UpdateVelocity>(
        std::bind(&Stub::Private::update_velocity,
                  std::ref(d),
                  std::placeholders::_1));
}

location::service::session::Stub::~Stub() noexcept
{
    ...
    d->object->uninstall_method_handler<location::service::session::Interface::UpdatePosition>();
    d->object->uninstall_method_handler<location::service::session::Interface::UpdateHeading>();
    d->object->uninstall_method_handler<location::service::session::Interface::UpdateVelocity>();
}

const dbus::types::ObjectPath& location::service::session::Stub::path() const
{
    return d->session_path;
}

void location::service::session::Stub::start_position_updates()
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::stop_position_updates() noexcept
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::start_velocity_updates()
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::stop_velocity_updates() noexcept
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::start_heading_updates()
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::stop_heading_updates() noexcept
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::Private::update_heading(const dbus::Message::Ptr& incoming)
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::Private::update_position(const dbus::Message::Ptr& incoming)
{
    VLOG(10) << __PRETTY_FUNCTION__;
...
void location::service::session::Stub::Private::update_velocity(const dbus::Message::Ptr& incoming)
{
    VLOG(10) << __PRETTY_FUNCTION__;
