 ...
 */
#ifndef LOCATION_SERVICE_COM_UBUNTU_LOCATION_BOOST_PTREE_SETTINGS_H_
#define LOCATION_SERVICE_COM_UBUNTU_LOCATION_BOOST_PTREE_SETTINGS_H_
...
#endif // LOCATION_SERVICE_COM_UBUNTU_LOCATION_BOOST_PTREE_SETTINGS_H_
