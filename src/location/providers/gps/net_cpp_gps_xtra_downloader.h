 ...
 */
#ifndef LOCATION_PROVIDERS_NET_CPP_GPS_XTRA_DOWNLOADER_H_
#define LOCATION_PROVIDERS_NET_CPP_GPS_XTRA_DOWNLOADER_H_
...
namespace location { namespace providers { namespace gps { namespace android {
...
#endif // LOCATION_PROVIDERS_NET_CPP_GPS_XTRA_DOWNLOADER_H_
