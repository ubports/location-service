 ...
 */
#ifndef LOCATION_PROVIDERS_NULL_GPS_XTRA_DOWNLOADER_H_
#define LOCATION_PROVIDERS_NULL_GPS_XTRA_DOWNLOADER_H_
...
#endif // LOCATION_PROVIDERS_NULL_GPS_XTRA_DOWNLOADER_H_
