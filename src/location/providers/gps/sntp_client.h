 ...
 */
#ifndef LOCATION_PROVIDERS_GPS_SNTP_CLIENT_H_
#define LOCATION_PROVIDERS_GPS_SNTP_CLIENT_H_
...
namespace location { namespace providers { namespace gps { namespace sntp {
...
#endif // LOCATION_PROVIDERS_GPS_SNTP_CLIENT_H_
