...
#ifndef LOCATION_PROVIDERS_SIRF_SERIAL_PORT_RECEIVER_H_
#define LOCATION_PROVIDERS_SIRF_SERIAL_PORT_RECEIVER_H_
...
#endif // LOCATION_PROVIDERS_SIRF_SERIAL_PORT_RECEIVER_H_
