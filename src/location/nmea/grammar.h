...
#ifndef LOCATION_NMEA_GRAMMAR_H_
#define LOCATION_NMEA_GRAMMAR_H_
...
public:
    ...
    boost::spirit::qi::rule<Iterator, float()> pdop;
    boost::spirit::qi::rule<Iterator, float()> hdop;
    boost::spirit::qi::rule<Iterator, float()> vdop;
...
#endif // LOCATION_NMEA_GRAMMAR_H_
